...
###      b. Indirect Region Elimination Algorithms:- Algorithms which uses derivative of the function to shortening the potential search space in every iteration fall under this category.
